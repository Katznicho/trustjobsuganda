            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-semibold text-gray-900">Applications for My Jobs</h3>
                            ...
                            <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition">
                                <div class="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <p class="text-gray-600">Applied by {{ $application->worker->full_name }}</p>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    <div>
                                        <span class="text-sm text-gray-500">Worker:</span>
                                        <p class="font-medium">{{ $application->worker->full_name }}</p>
                                        <p class="text-sm text-gray-600">{{ $application->worker->email }}</p>
                                        <p class="text-sm text-gray-600">{{ $application->worker->phone_e164 }}</p>
                                    </div>
                                    <div>
                                ...
                                <div class="mb-4">
                                    <span class="text-sm text-gray-500">Cover Letter:</span>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500 mb-6">Applications will appear here once workers apply to your jobs.</p>
